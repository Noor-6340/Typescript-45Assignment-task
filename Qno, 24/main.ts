...
let name1 : string = "Shumaila"
let name2 : string = "Shumaila Jabeen"
let name3 : string = "Shumaila Jabeen Noor"

if(name1 == name3){console.log("names are equal")
}
...
let country: string[] = ["Pakistan","Turkey","Dubai","Qatar","SouthAfrica"]
